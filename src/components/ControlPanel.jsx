...
export default function ControlPanel({ onRun, onPause, onReset, onFromSelect, onToSelect, isLoading, mapboxToken, routeFound, routeDistanceKm, }) {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }} className="absolute bottom-0 lg:bottom-6 left-0 lg:left-3 z-10 w-full max-w-xl lg:px-4">

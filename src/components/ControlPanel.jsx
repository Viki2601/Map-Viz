...
export default function ControlPanel({ onRun, onPause, onReset, onFromSelect, onToSelect, isLoading, mapboxToken, routeFound, routeDistanceKm, }) {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }} className="absolute bottom-6 left-3 z-10 w-full max-w-xl px-4">
            <div className="rounded-2xl" style={{ background: 'rgba(6,8,6,0.23)', backdropFilter: 'blur(20px)', boxShadow: '0 0 20px rgba(0,0,0,0.6)', padding: '16px' }}>
